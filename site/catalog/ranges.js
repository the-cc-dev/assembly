...
function RangesEl(props) {
  let inputClasses = `range range--${props.color} w192`;
    ...
    return (
      <div>
        ...
        <div className='mb12 flex-parent flex-parent--center-cross'>
          <input className='input w192' />
          <div className='range w192'>
            <input type='range' />
          </div>
        </div>
        <div className='mb12 flex-parent flex-parent--center-cross'>
          <input className='input input--s w192' />
          <div className='range range--s w192'>
            <input type='range' />
          </div>
        </div>
